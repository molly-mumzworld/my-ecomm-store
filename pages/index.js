...
import { Dialog, Popover, Tab, Transition, Switch } from '@headlessui/react'
            ...
            <div className="max-w-7xl mx-auto h-10 px-4 flex items-center justify-between sm:px-6 lg:px-8">
              ...
              <form className="hidden lg:block lg:flex-1">
                <div className="flex">
                  ...
                  <div className="-ml-2 group relative bg-white border-transparent rounded-md focus-within:ring-2 focus-within:ring-white">
                    <select
                      id="desktop-currency"
                      name="currency"
                      className="bg-none bg-white border-transparent rounded-md py-0.5 pl-2 pr-5 flex items-center text-sm font-medium text-gray-700 group-hover:text-gray-700 focus:outline-none focus:ring-0 focus:border-transparent"
                    >
                      {currencies.map((currency) => (
                        <option key={currency}>{currency}</option>
                      ))}
              ...
              <div className="border-b border-gray-200">
                <div className="h-16 flex items-center justify-between">
                  ...
                  <div className="hidden lg:flex lg:items-center">
                    <a href="#">
                      <span className="sr-only">Mumzworld</span>
                      <img
